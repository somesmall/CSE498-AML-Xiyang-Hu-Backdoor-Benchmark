...
class GTSRB(Dataset):
    def __init__(self, opt, train, transforms):
        ...
        if train == 'Train':
            self.data_folder = os.path.join(opt.data_path, "Dataset_IJCAI/GTSRB/Train")
            self.images, self.labels = self._get_data_train_list()
        elif train == 'Eval':
            self.data_folder = os.path.join(opt.data_path, "Dataset_IJCAI/GTSRB/Test")
...
class CelebA(Dataset):
    def __init__(self, opt, flag, transforms):
        ...
        with open(os.path.join(opt.data_path,'Dataset_IJCAI/CelebA/CelebA_trainpaths'),'r') as f:
            self.trainpaths = json.load(f)
        self.trainpaths_keys = list(self.trainpaths.keys())
        with open(os.path.join(opt.data_path,'Dataset_IJCAI/CelebA/CelebA_valpaths'),'r') as f:
